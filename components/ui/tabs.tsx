 ...
 * -------------------
 * Tabbed navigation for multi-panel views (bot settings, analytics sub-pages, the
 * conversation detail). Radix Tabs handles keyboard nav (left/right arrows), ARIA
 * tablist/tab/tabpanel semantics, and the controlled/uncontrolled modes.
 */
"use client";
