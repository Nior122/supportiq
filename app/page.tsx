  ...
  return (
    <div className="relative flex flex-col min-h-screen">
      ...
      <main className="flex-1">
        {/* ─── Hero ─── */}
        <section className="relative pt-24 lg:pt-32 min-h-[80vh] flex flex-col items-center justify-center pointer-events-none">
          <div className="container relative px-6 pointer-events-auto">
        ...
        {/* ─── Features (Grid) ─── */}
        <section id="features" className="container px-6 py-24 lg:py-32 pointer-events-none">
          ...
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {features.map((feature, i) => (
              <motion.div
                ...
                viewport={{ once: true }}
                className="group relative flex flex-col rounded-2xl border border-white/10 bg-white/5 backdrop-blur-md p-8 shadow-sm transition-all hover:bg-white/10 hover:border-white/20 pointer-events-auto cursor-default"
              >
        ...
        {/* ─── Steps ─── */}
        <section className="py-24 lg:py-32 pointer-events-none">
          <div className="container px-6 pointer-events-auto">
        ...
        {/* ─── Pricing ─── */}
        <section id="pricing" className="container px-6 py-24 lg:py-32 pointer-events-none">
          <div className="mx-auto max-w-3xl text-center mb-20">
          ...
          <div className="grid gap-6 lg:grid-cols-3">
            {pricingTiers.map((tier) => (
              <Card
                key={tier.name}
                className={`flex flex-col rounded-3xl p-8 backdrop-blur-md transition-transform hover:scale-[1.02] bg-white/5 border-white/10 pointer-events-auto ${
        ...
        {/* ─── FAQ ─── */}
        <section id="faq" className="py-24 lg:py-32 pointer-events-none">
