      ...
      <main className="flex-1">
        ...
        <section className="relative overflow-hidden pt-24 lg:pt-32">
          ...
          <div className="container relative px-6">
            <div className="mx-auto max-w-[800px] text-center">
              ...
              >
                <span className="inline-flex items-center gap-2 rounded-full border border-primary/30 bg-primary/5 px-3 py-1 text-[11px] font-semibold uppercase tracking-wider text-primary">
                ...
                <h1 className="mt-8 text-5xl font-bold tracking-[-0.03em] sm:text-7xl lg:text-[84px] lg:leading-[1.1] text-primary">
                  AI support that{" "}
            ...
            >
              <div className="relative rounded-2xl border border-primary/20 bg-black/50 p-2 shadow-2xl backdrop-blur-sm">
                <div className="overflow-hidden rounded-xl border border-primary/20 bg-primary/5 shadow-inner">
                  ...
                  <div className="flex h-10 items-center gap-2 border-b border-primary/20 bg-primary/10 px-4">
                    ...
                    <div className="mx-auto h-5 w-48 rounded-md bg-primary/20" />
                  </div>
        ...
        <section id="features" className="container px-6 py-24 lg:py-32">
          <div className="mx-auto max-w-3xl text-center">
            <h2 className="text-3xl font-bold tracking-tight sm:text-5xl text-primary">Built for precision</h2>
          ...
          <div className="mt-20 grid gap-4 sm:grid-cols-2 lg:grid-cols-6">
            {features.map((feature, i) => (
              <motion.div
                ...
                viewport={{ once: true }}
                className={`${feature.size === "large" ? "lg:col-span-3" : "lg:col-span-2"} group relative rounded-2xl border border-primary/20 bg-black p-8 shadow-sm transition-all hover:border-primary/40`}
              >
                ...
                <p className="mt-2 text-[15px] leading-relaxed text-primary/60">
                  {feature.description}
                </p>
              </motion.div>
            ))}
          ...
          <div className="container px-6">
            <div className="flex flex-col items-center justify-between gap-12 lg:flex-row">
              <div className="max-w-[480px]">
                <h2 className="text-3xl font-bold tracking-tight sm:text-4xl text-primary">Go live in three simple steps.</h2>
                <p className="mt-4 text-lg text-primary/60">
                ...
                <div className="mt-10 space-y-8">
                  {[
                    ...
                    <div key={i} className="flex gap-4">
                      <div className="flex h-6 w-6 shrink-0 items-center justify-center rounded-full bg-primary text-[11px] font-bold text-black">
                        {i + 1}
                      </div>
                      <div>
              ...
              <div className="relative aspect-square w-full max-w-[500px] rounded-3xl border border-primary/20 bg-black shadow-elevated overflow-hidden">
        ...
        <section id="pricing" className="container px-6 py-24 lg:py-32">
          <div className="mx-auto max-w-3xl text-center">
            <h2 className="text-3xl font-bold tracking-tight sm:text-5xl text-primary">Simple pricing</h2>
            <p className="mt-4 text-lg text-primary/60">
          ...
          <div className="mt-20 grid gap-6 lg:grid-cols-3">
            {pricingTiers.map((tier) => (
              <Card
                key={tier.name}
                className={`flex flex-col rounded-3xl p-8 shadow-card bg-black transition-transform hover:scale-[1.02] ${
              ...
              >
                <div className="mb-8">
                  ...
                  <div className="mt-4 flex items-baseline gap-1">
                    ...
                    <span className="text-sm text-primary/60">/mo</span>
                  </div>
